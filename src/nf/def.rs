...
pub struct NFEventHandler {
    ...
    pub tcp_receive: unsafe extern fn(id: u64, buf: &u8, len: i32),
    pub tcp_send: unsafe extern fn(id: u64, buf: &u8, len: i32),
    ...
    pub udp_receive: unsafe extern fn(id: u64, remote: &NFSockAddr, buf: &u8, len: i32, options: &NFUdpOptions),
    pub udp_send: unsafe extern fn(id: u64, remote: &NFSockAddr, buf: &u8, len: i32, options: &NFUdpOptions),
